...
async function runPageSpeedTest(url) {
  try {
    ...
    // Prefer environment variable for security, fallback to direct key
    const apiKey = process.env.GOOGLE_PAGESPEED_API_KEY || 'AIzaSyBD53zUf_82qIn79_Na8J8yibhS0Ch8AWk';
    const apiUrl = `https://www.googleapis.com/pagespeedonline/v5/runPagespeed?url=${encodeURIComponent(url)}&category=performance&strategy=mobile&key=${apiKey}`;
